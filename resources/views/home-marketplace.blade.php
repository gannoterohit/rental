        ...
        <div class="market-wrap">
            <div class="market-hero-box">
                ...
                <div class="market-hero-copy">
                    ...
                    <h1>{{ $text('home_hero_title','Find a place that feels right') }} <span>{{ $homeCity ? 'in '.$homeCity : $text('home_hero_highlight','near you') }}</span></h1>
                ...
                <form action="{{ route('rooms.index') }}" method="GET" class="market-search">
                    <div class="market-search-grid">
                        <div class="market-field"><label>Where do you want to live?</label><input name="city" value="{{ $homeCity }}" placeholder="Enter city or locality"></div>
